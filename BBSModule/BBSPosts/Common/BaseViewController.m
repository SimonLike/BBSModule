...
- (void)viewDidLoad {
    ...
    self.navigationController.navigationBar.barTintColor = RGBCOLOR16(0x55baf4);//F54E54
    NSDictionary * dict = [NSDictionary dictionaryWithObjects:[NSArray arrayWithObjects:RGBCOLOR16(0xffffff),[UIFont systemFontOfSize:16],nil]
