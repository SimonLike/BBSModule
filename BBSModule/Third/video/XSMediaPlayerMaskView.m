...
//        self.bottomImageView.backgroundColor = [UIColor redColor];
        ...
        self.bottomImageView.frame = CGRectMake(0,height-APP_SPACE(110), width, APP_SPACE(50));

        self.startBtn = [[UIButton alloc]initWithFrame:CGRectMake(0, 0,APP_SPACE(50),APP_SPACE(50))];
...
//        self.fullScreenBtn.backgroundColor = [UIColor redColor];
        ...
        self.currentTimeLabel = [[UILabel alloc]initWithFrame:CGRectMake(APP_SPACE(50), APP_SPACE(10),APP_SPACE(60), APP_SPACE(30))];
...
-(void)layoutSubviews
{
    ...
    self.topImageView.frame = CGRectMake(0, 0,width, APP_SPACE(50));

    self.bottomGradientLayer.frame = self.bottomImageView.bounds;
    self.topGradientLayer.frame    = self.topImageView.bounds;

    
    self.fullScreenBtn.frame = CGRectMake(width-APP_SPACE(50),0,APP_SPACE(50),APP_SPACE(50));
    
    CGFloat progressWidth = width-2*(self.startBtn.frame.size.width+self.currentTimeLabel.frame.size.width);
    
    self.progressView.frame = CGRectMake(0,0,progressWidth,APP_SPACE(20));
    self.progressView.center = CGPointMake(width/2, APP_SPACE(25));
    self.totalTimeLabel.frame = CGRectMake(width-APP_SPACE(110),APP_SPACE(10),APP_SPACE(60),APP_SPACE(30));
    self.videoSlider.frame = self.progressView.frame;
    self.activity.center = CGPointMake(width/2, height/2);
    self.volumeProgress.bounds = CGRectMake(0, 0,APP_SPACE(100),APP_SPACE(30));
    self.volumeProgress.center = CGPointMake(APP_SPACE(40),height/2);
